...
| 2 | `file_picker`                  | ^8.1.2   | MIT                      | https://github.com/miguelpruivo/flutter_file_picker                 |
| 3 | `path_provider`                | ^2.1.4   | BSD-3-Clause             | https://github.com/flutter/packages                                 |
| 4 | `permission_handler`           | ^11.3.1  | MIT                      | https://github.com/baseflow/flutter-permission-handler              |
...
| 8 | `csv`                          | ^6.0.0   | MIT                      | https://github.com/close2/csv                                       |
...
| 15 | `syncfusion_flutter_pdf`      | ^27.1.48 | Syncfusion EULA          | https://pub.dev/packages/syncfusion_flutter_pdf                     |
| 16 | `syncfusion_flutter_pdfviewer` | ^27.1.48 | Syncfusion EULA          | https://pub.dev/packages/syncfusion_flutter_pdfviewer               |
| 17 | `http`                        | ^1.2.0   | BSD-3-Clause             | https://github.com/dart-lang/http                                   |
| 18 | `intl`                        | ^0.19.0  | BSD-3-Clause             | https://github.com/dart-lang/i18n                                   |
