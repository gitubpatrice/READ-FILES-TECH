...
class _AboutScreenState extends State<AboutScreen> {
  ...
  static const _features = [
    (
      ...
      label: 'Lecteur',
      desc:
          'TXT, MD, JSON, XML, HTML, CSS, JS, PHP, CSV, XLSX, DOCX, ODT, PDF, ZIP, images',
    ),
    (
    ...
    (
      ...
      label: 'Outils',
      desc:
          'Color picker, diff, hash, encodage, formater, recherche contenu, créer ZIP',
    ),
    (
  ...
  Future<void> _checkUpdate() async {
    ...
    final info = await AppUpdate.checkForUpdate(force: true);
    if (!mounted) return;
