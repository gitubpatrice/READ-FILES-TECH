  ...
  Future<void> _openFile(String path) async {
    ...
    if (screen == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Format ".$ext" non supporté')));
      return;
    }
...
class _HomeTabState extends State<_HomeTab> {
  ...
  static const _quickFolders = [
    ...
    (
      ...
      filter: {'mp4', 'mov', 'avi', 'mkv', 'webm', '3gp'},
    ),
    (
    ...
    (
      ...
      filter: {'jpg', 'jpeg', 'png', 'gif', 'webp', 'heic'},
    ),
  ];
  ...
  void _openFolder(String path, {Set<String>? filter, String? title}) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => FileExplorerScreen(
          initialPath: path,
          extensionFilter: (filter != null && filter.isNotEmpty)
              ? filter
              : null,
          title: title,
        ),
          ...
          children: [
            ..._quickFolders.map(
              (f) => _FolderCard(
                ...
                color: f.color,
                onTap: () =>
                    _openFolder(f.path, filter: f.filter, title: f.label),
              ),
            ),
            _FolderCard(
  ...
  Widget build(BuildContext context) {
    final tools = [
      ...
      (
        ...
        label: 'Outils TXT',
        subtitle: 'Mots, recherche, PDF',
        color: Colors.blueGrey,
        screen: const TxtToolsScreen(),
      ),
      (
        icon: Icons.table_chart_outlined,
        label: 'Outils CSV',
        subtitle: 'Stats, PDF, fusion',
        color: Colors.green,
        screen: const CsvToolsScreen(),
      ),
      (
        icon: Icons.difference_outlined,
        label: 'Comparer',
        subtitle: 'Diff de deux fichiers',
        color: Colors.indigo,
        screen: const DiffScreen(),
      ),
      (
      ...
      (
        ...
        color: Colors.orange,
        screen: const EncodeScreen(),
      ),
      (
        icon: Icons.auto_fix_high,
        label: 'Formater',
        subtitle: 'JSON, CSS, JS',
        color: Colors.purple,
        screen: const FormatScreen(),
      ),
      (
      ...
      (
        ...
        label: 'Chercher',
        subtitle: 'Dans le contenu des fichiers',
        color: Colors.deepOrange,
        screen: const ContentSearchScreen(),
      ),
      (
      ...
      (
        ...
        label: 'Créer ZIP',
        subtitle: 'Compresser des fichiers',
        color: Colors.orange,
        screen: const ZipCreatorScreen(),
      ),
      (
        icon: Icons.transform,
        label: 'Convertir',
        subtitle: 'Images/PDF, CSV/XLSX, TXT/PDF',
      ...
      (
        ...
        label: 'OCR',
        subtitle: 'Image vers texte (local)',
        color: Colors.blue,
      ...
      (
        icon: Icons.compress,
        label: 'Compresser',
        subtitle: 'Réduire la taille des images',
        color: Colors.amber,
      ...
      (
        icon: Icons.shield_outlined,
        label: 'Coffre fort',
        subtitle: 'Fichiers chiffrés AES-256',
        color: Colors.red,
      ...
      (
        ...
        label: 'Effacer EXIF',
        subtitle: 'Supprimer GPS/date des images',
        color: Colors.brown,
        screen: const ExifScreen(),
      ),
      (
        icon: Icons.travel_explore,
        label: 'Recherche globale',
        subtitle: 'Par nom et contenu, tout le téléphone',
        color: Colors.indigo,
