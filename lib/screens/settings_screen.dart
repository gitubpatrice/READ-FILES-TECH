...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          Card(
            child: Column(children: [
              ...
              ListTile(
                ...
                title: const Text('Restaurer le dossier par défaut',
                    style: TextStyle(fontSize: 13)),
                subtitle: const Text('/storage/emulated/0/Files Tech',
            ...
            child: Column(children: [
              for (final c in OutputCategory.values)
                ListTile(
                  ...
                  title: Text(c.folderName,
                      style: const TextStyle(fontSize: 13)),
                  subtitle: Text('$_basePath/${c.folderName}',
  ...
  IconData _iconFor(OutputCategory c) {
    switch (c) {
      case OutputCategory.scans:        return Icons.document_scanner_outlined;
      case OutputCategory.conversions:  return Icons.transform;
      case OutputCategory.compressions: return Icons.compress;
      case OutputCategory.signatures:   return Icons.draw_outlined;
      case OutputCategory.exifClean:    return Icons.cleaning_services_outlined;
      case OutputCategory.ocr:          return Icons.text_snippet_outlined;
    }
  }
